...
TACTIC_SECTION_TEMPLATE = """--- Learned Strategy (from successful past negotiations) ---
...
class NegotiatingAgent(BaseAgent):
    """
    ...
    def __init__(
        ...
        learned_tactic: dict | None = None,   # Phase 2: {"description": ..., "example": ...}
        ...
        super().__init__(role=role, system_prompt=system_prompt, client=client, temperature=temperature)
